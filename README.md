...
StayEasy/
├── css/
│   ├── Admin.css       # File style riêng cho trang Quản trị
│   └── style.css       # File style riêng cho trang Khách hàng
├── img/                # Thư mục chứa hình ảnh dự án (nếu có)
├── Js/
│   ├── admin.js        # Logic xử lý giao diện và CRUD của Admin
│   ├── api.js          # Chứa cấu hình Endpoint và các hàm Fetch API (GET, POST, PUT, DELETE)
│   ├── main.js         # Logic xử lý giao diện Khách hàng (Render, Lọc, Đặt phòng)
│   └── utils.js        # Chứa các hàm dùng chung (Định dạng tiền tệ, Tính số ngày...)
├── admin.html          # File HTML giao diện Quản trị viên
├── index.html          # File HTML giao diện Khách hàng (Trang chủ)
└── README.md           # Tài liệu hướng dẫn dự án
\`\`\`

## 🚀 Hướng dẫn cài đặt và chạy dự án

Dự án này là Frontend thuần, không yêu cầu cài đặt Node.js hay môi trường Backend phức tạp.
...
2. **Cấu hình API:**
   ...
   - Mở file `Js/api.js`, thay thế biến `BASE_URL` bằng đường link API của bạn.
     ...
     ```
3. **Khởi chạy:** - Khuyên dùng extension **Live Server** trên VS Code để chạy dự án nhằm tránh các lỗi về CORS khi fetch API.
